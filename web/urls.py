...
urlpatterns = [
    ...
    path('addwishlist/<slug:slug>/', views.add_to_wishlist, name='addwishlist'),
    path('removewishlist/<slug:slug>/', views.remove_from_wishlist, name='removewishlist'),
    path('cartfromwishlist/<slug:slug>/', views.cart_from_wishlist, name='cartfromwishlist'),
    ...
    path('removefrmcheckout/<slug:slug>/', views.remove_from_checkout, name='removefrmcheckout'),
